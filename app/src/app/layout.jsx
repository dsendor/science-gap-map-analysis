...
export const metadata = {
  title: 'The Gap Map, with three gaps broken into critical paths',
  description:
    "David Sendor's extension of Convergent Research's Fundamental Development Gap Map v1.0: three gaps decomposed into the steps they run through, showing where AI reaches and which steps have no capability attached, plus a kind-of-work label on all 103 gaps. An independent contribution, offered for feedback.",
};
